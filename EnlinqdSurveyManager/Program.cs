...
namespace EnlinqdSurveyManager
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddDbContext<SurveyContext>(options => options.UseSqlServer(builder.Configuration.GetConnectionString("SurveyContext")));
            ...
            //Get Surveys
            app.MapGet("/surveys", (SurveyContext context) =>
            {
            ...
            app.MapPost("/add-survey", (SurveyDefinition survey, SurveyContext context) =>
            {
